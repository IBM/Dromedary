...
The code is adapted from the [llama](https://github.com/facebookresearch/llama) inference code, with the support for [Multi-Query Attention (MQA)](https://arxiv.org/abs/2305.13245).

Below is copied from LLaMA GitHub repository in 2023-10-05.
